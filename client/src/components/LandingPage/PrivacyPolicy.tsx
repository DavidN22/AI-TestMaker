const PrivacyPolicy = () => (
  <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-900 shadow-md rounded px-8 py-10 my-12 text-gray-800 dark:text-gray-100">

    <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Privacy Policy for Teskro</h1>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">What User Data We Collect</h2>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Why We Collect Your Data</h2>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Safeguarding and Securing the Data</h2>
    <p className="mb-4">
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Our Cookie Policy</h2>
    <p className="mb-4">
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Third-Party Sharing</h2>
    <p className="mb-4">
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Restricting the Collection of Your Personal Data</h2>
    <p className="mb-4">
    ...
    <p>
      ...
      <a href="mailto:naymondavid@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">
