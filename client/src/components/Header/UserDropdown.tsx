  ...
  export default function UserDropdown({ onSettingsOpen, onLogout }: UserDropdownProps) {
    ...
    return (
      <Menu as="div" className="relative inline-block text-left">
        <MenuButton className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-900 dark:bg-gray-100 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
