...
router.post(
  ...
  getTokenMiddleware,
  studyController.generateFlashcards
);
...
router.post(
  ...
  decodeUserMiddleware,
  getTokenMiddleware,
  studyController.generateFlashcardsFromTest
);
...
router.get(
  "/flashcardHistory",
  decodeUserMiddleware,
  studyController.getFlashcardHistory
);

// Toggle favorite for an individual flashcard
router.patch(
  "/flashcardFavorite/:flashcardId",
  decodeUserMiddleware,
  studyController.toggleFlashcardFavorite
);
...
router.delete(
  ...
  decodeUserMiddleware,
  studyController.deleteFlashcardSet
);
...
router.get(
  "/individualFavorites",
  decodeUserMiddleware,
  studyController.getIndividualFavorites
);
...
router.post(
  "/individualFavorite",
  decodeUserMiddleware,
  studyController.toggleIndividualFavorite
);

// Check if individual flashcard is favorited
router.post(
  "/checkIndividualFavorite",
  decodeUserMiddleware,
  studyController.checkIndividualFavorite
);
